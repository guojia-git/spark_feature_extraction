...
ft_date_1 = fe.get_range_filter("date", low="offerdate-30", high="offerdate", function=date_to_int)
ft_date_2 = fe.get_range_filter("date", low="offerdate-60", high="offerdate", function=date_to_int)
